				...
				for(int i = 0; i<P1.size();i++){
					if(P1.get(i).getDirection()){
						...
						case 3:
							...
							break;
						case 4:
							g.drawImage(pic.clRi(), ((width/50)*P1.get(i).X())+1, ((height/50) * P1.get(i).Y())+1, width/50-1, height/50-1, null);
							break;
						}
					}
					else{
						...
						case 3:
							...
							break;
						case 4:
							g.drawImage(pic.clLi(), ((width/50)*P1.get(i).X())+1, ((height/50) * P1.get(i).Y())+1, width/50-1, height/50-1, null);
							break;
						}
				...
				for(int o = 0; o<P2.size(); o++){	
					if(P2.get(o).getDirection()){
						...
						case 3:
							...
							break;
						case 4:
							g.drawImage(pic.aoRi(), ((width/50)*P2.get(o).X())+1, ((height/50) * P2.get(o).Y())+1, width/50-1, height/50-1, null);
							break;
						}
					}
					else{
						...
						case 3:
							...
							break;
						case 4:
							g.drawImage(pic.aoLi(), ((width/50)*P2.get(o).X())+1, ((height/50) * P2.get(o).Y())+1, width/50-1, height/50-1, null);
							break;
						}
